...
('Batman: Hush', 'Uno de los misterios más grandes del Caballero Oscuro.', 'Superhéroes', 2002, 'imagen/img_obras/comics/batman_hush.jpg', 0, 'Norma Editorial'),
...
INSERT INTO obra (titulo, descripcion, genero, anno_lanzamiento, portada, tipo, nombre_editorial) VALUES 
('Project Hail Mary', 'Un hombre despierta en una nave espacial sin recordar quién es.', 'Ciencia Ficción', 2021, 'imagen/img_obras/libros/hail_mary.jpg', 2, 'B de Bolsillo'),
('The Martian', 'Un astronauta queda atrapado en Marte y debe sobrevivir con su ingenio.', 'Ciencia Ficción', 2011, 'imagen/img_obras/libros/martian.jpg', 2, 'B de Bolsillo'),
('El Imperio Final', 'Un mundo donde el héroe profetizado falló y el mal gobierna.', 'Fantasía', 2006, 'imagen/img_obras/libros/mistborn.jpg', 2, 'Debolsillo'),
