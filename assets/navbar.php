...
<nav class="bg-neutral-900 p-6 grid grid-cols-1 md:grid-cols-3 items-center border-b-8 border-black sticky top-0 z-50">
        ...
        <div class="flex justify-center items-center gap-8 font-comic text-xl">
            ...
            <a href="<?= $path ?>social.php" class="<?= ($pagina_actual == 'social.php') ? 'text-rose-800' : 'hover:text-rose-800' ?> hover:text-white-800 transition-colors uppercase tracking-widest">Social</a>
        </div>
        <div class="flex justify-end items-center gap-4">
            ...
            <a class="bg-rose-800 text-white px-4 py-2 border-4 border-black font-bold hover:bg-rose-900 transition-all shadow-[4px_4px_0_0_black] active:shadow-none active:translate-y-1 text-xs" href="<?= $path ?>perfilUsuario.php?usuario=<?= $_SESSION['nombre'] ?>">MI CUENTA</a>
