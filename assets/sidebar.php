...
<!-- Panel lateral -->
<div id="sidebarPanel" class="fixed top-0 left-0 h-full w-[85vw] max-w-sm md:max-w-none md:w-96 bg-neutral-900 border-r-8 border-black z-[70] transform -translate-x-full transition-transform duration-300 ease-in-out flex flex-col p-6 md:p-8 shadow-[10px_0_0_0_rgba(0,0,0,0.3)] overflow-y-auto">
    ...
    <nav class="flex flex-col gap-8">
        ...
        <a href="<?= $path_sb ?>webcontent/comparar.php" class="font-comic text-xl md:text-2xl text-yellow-500 hover:text-rose-800 transition-all uppercase tracking-widest flex items-center gap-3 group">
        ...
        <a href="<?= $path_sb ?>webcontent/pricing.php" class="font-comic text-2xl text-white hover:text-rose-800 transition-all uppercase tracking-widest flex items-center gap-3 group">
            <span class="w-2 h-2 bg-rose-800 group-hover:w-4 transition-all"></span>
            Planes y precios
        </a>
        <a href="<?= $path_sb ?>webcontent/eventos.php" class="font-comic text-2xl text-white hover:text-rose-800 transition-all uppercase tracking-widest flex items-center gap-3 group">
            <span class="w-2 h-2 bg-rose-800 group-hover:w-4 transition-all"></span>
            Eventos
        </a>
        <a href="<?= $path_sb ?>webcontent/faq.php" class="font-comic text-2xl text-white hover:text-rose-800 transition-all uppercase tracking-widest flex items-center gap-3 group">
            <span class="w-2 h-2 bg-rose-800 group-hover:w-4 transition-all"></span>
            Preguntas frecuentes
        </a>
        <a href="<?= $path_sb ?>webcontent/nosotros.php" class="font-comic text-2xl text-white hover:text-rose-800 transition-all uppercase tracking-widest flex items-center gap-3 group">
            <span class="w-2 h-2 bg-rose-800 group-hover:w-4 transition-all"></span>
            Sobre nosotros
        </a>
    </nav>
