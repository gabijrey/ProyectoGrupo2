...
<body class="text-white min-h-screen">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        <aside class="w-full md:w-64 bg-neutral-900 border-b-8 md:border-b-0 md:border-r-8 border-black p-6 flex flex-col justify-between">
            <div>
                <div class="mb-10 text-center md:text-left">
                    <img src="../logos/logoLight.webp" class="h-10 w-auto inline-block drop-shadow-[4px_4px_0_black]" alt="ComicLook">
                </div>
                
                <nav class="space-y-4">
                    <a href="user.php" class="flex items-center gap-3 bg-yellow-500 text-black font-bold uppercase px-4 py-3 border-4 border-black shadow-[4px_4px_0_0_black] hover:scale-105 hover:-rotate-2 transition-all">
                    ...
                    <a href="" class="flex items-center gap-3 text-white font-bold uppercase px-4 py-3 border-4 border-transparent hover:border-black hover:bg-rose-800 transition-all hover:scale-105">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z"/><path d="m9 12 2 2 4-4"/></svg>
                        Mis Reseñas
                    </a>
                    <a href="../index.php" class="flex items-center gap-3 text-white font-bold uppercase px-4 py-3 border-4 border-transparent hover:border-black hover:bg-neutral-800 transition-all hover:scale-105">
            ...
            <div class="mt-10 border-t-4 border-black pt-6">
                <a href="sesion/logout.php" class="flex items-center gap-3 text-rose-800 font-bold uppercase hover:text-rose-600 transition-colors">
